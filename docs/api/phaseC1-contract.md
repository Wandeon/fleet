...
| Endpoint | Purpose | Status |
| --- | --- | --- |
| `GET /health/summary` | Provide module-level health snapshot for layout banner. | Already implemented. |
| `GET /events/recent` | Cross-module recent activity feed powering layout sidebar. | Already implemented. |
